...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Reduce 검사결과</h1>
                        ...
                        <div class="card-body">
                            ...
                            <tr>
                                    ...
                                    <tbody>
                                    	<tr>
                                    		<th>OD1 검사값</th>
                                    		<td><span class="form-control val-area" id="longC1">${eDataInfo.iehOd3}</span></td>
                                    		<th>OD1 기준값</th>
                                    	...
                                    	<tr>
                                    		<th>OD1-2 검사값</th>
                                    		<td><span class="form-control val-area" id="longC2">${eDataInfo.iehOd4}</span></td>
                                    		<th>OD1-2 기준값</th>
                                    		<td><span class="form-control val-area">${spcInfo.ssiOd01}</span></td>
                                    		<th>OD1-2 상하한</th>
                                    	...
                                    	<tr>
                                    		<th>OD2 검사값</th>
                                    		<td><span class="form-control val-area" id="longC3">${eDataInfo.iehOd1}</span></td>
                                    		<th>OD2 기준값</th>
                                    		<td><span class="form-control val-area">${spcInfo.ssiOd02}</span></td>
                                    		<th>OD2 상하한</th>
                                    		<td><span class="form-control val-area" id="longG3">${spcInfo.ssiOd02Min}~${spcInfo.ssiOd02Max}</span></td>
                                    		<th>합격여부</th>
                                    		<td><span class="form-control val-area" id="longF3"></span></td>
                                    	</tr>
                                    	<tr>
                                    		<th>OD2-2 검사값</th>
                                    		<td><span class="form-control val-area" id="longC4">${eDataInfo.iehOd2}</span></td>
                                    		<th>OD2-2 기준값</th>
                                    		<td><span class="form-control val-area">${spcInfo.ssiOd02}</span></td>
                                    		<th>OD2-2 상하한</th>
                                    		<td><span class="form-control val-area" id="longG4">${spcInfo.ssiOd02Min}~${spcInfo.ssiOd02Max}</span></td>
                                    		<th>합격여부</th>
                                    		<td><span class="form-control val-area" id="longF4">${detail.iehId4}</span></td>
                                    	</tr>
										...
										<tr>
											...
											<th>ID2-1 상하한</th>
											<td><span class="form-control val-area" id="longG5">${spcInfo.ssiId02Min}~${spcInfo.ssiId02Max}</span></td>
											<th>합격여부</th>
										...
										<tr>
											...
											<td><span class="form-control val-area">${spcInfo.ssiId02}</span></td>
											<th>ID2-2 상하한</th>
											<td><span class="form-control val-area" id="longG6">${spcInfo.ssiId02Min}~${spcInfo.ssiId02Max}</span></td>
											<th>합격여부</th>
										...
										<tr>
											...
											<th>T2-1 하한</th>
											<td><span class="form-control val-area" id="tG5">${spcInfo.ssiT1BodyMin}</span></td>
											<th>합격여부</th>
										...
										<tr>
											...
											<td><span class="form-control val-area">${spcInfo.ssiT1Body}</span></td>
											<th>T2-2 하한</th>
											<td><span class="form-control val-area" id="tG6">${spcInfo.ssiT1BodyMin}</span></td>
											<th>합격여부</th>
										...
										<tr>
											...
											<td><span class="form-control val-area">${spcInfo.ssiT1Body}</span></td>
											<th>T2-3 하한</th>
											<td><span class="form-control val-area" id="tG7">${spcInfo.ssiT1BodyMin}</span></td>
											<th>합격여부</th>
										...
										<tr>
											...
											<td><span class="form-control val-area">${spcInfo.ssiT1Body}</span></td>
											<th>T2-4 하한</th>
											<td><span class="form-control val-area" id="tG8">${spcInfo.ssiT1BodyMin}</span></td>
											<th>합격여부</th>
										...
										<tr>
											...
											<th>합격여부</th>
											<td><span class="form-control val-area" id="blF5"></span></td>
										</tr>
										<tr>
											<th>BL2-2 검사값</th>
										...
										<tr>
											<th>H 검사값</th>
											<td><span class="form-control val-area" id="aC1">${eDataInfo.iehH}</span></td>
											<th>H 기준값</th>
											<td><span class="form-control val-area">${spcInfo.ssiReduH}</span></td>
											<th>H 상하한</th>
											<td><span class="form-control val-area" id="aG1">${spcInfo.ssiReduHMin}~${spcInfo.ssiReduHMax}</span></td>
											<th>합격여부</th>
											<td><span class="form-control val-area" id="aF1">${detail.iehBl34}</span></td>
	...
	function jugment4() {
	    ...
	    for (var i = 1; i < 5; i++) {
	        aC = parseFloat($('#aC' + i).text());
	        aG = $('#aG' + i).text();
	        console.log(aG);
	        var arr3 = aG.split('~');
	        var downVal4 = parseFloat(arr3[0]);
	        var upVal4 = parseFloat(arr3[1]);
